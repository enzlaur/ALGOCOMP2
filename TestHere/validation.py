...
def printfreq():
    global freq
    print("Freq from validation: " + str(freq))
...
def _assert_all_finite(X):
    ...
    # print("_assert_all_finite has been called")
    addfreq()
    X = np.asanyarray(X)
...
def assert_all_finite(X):
    ...
    # print("asser_all_finite has been called")
    addfreq()
...
def as_float_array(X, copy=True, force_all_finite=True):
    ...
    """
    # print("as_float_array has been called")
    addfreq()
...
def _is_arraylike(x):
    ...
    # print("_is_arraylike has been called")
    addfreq()
...
def _num_samples(x):
    ...
    # print("_num_samples has been called")
    addfreq()
    if hasattr(x, 'fit'):
...
def _shape_repr(shape):
    ...
    '()'
    """
    # print("_shape_repr has been called")
    addfreq()
    if len(shape) == 0:
        return "()"
...
def indexable(*iterables):
    ...
    *iterables : lists, dataframes, arrays, sparse matrices
    ...
    """
    # print("indexable has been called")
    addfreq()
    result = []
    for X in iterables:
        addfreq()
...
def _ensure_sparse_format(spmatrix, accept_sparse, dtype, copy,
    ...
    """
    # print("_ensure_sparse_format has been called")
    addfreq()
...
def check_array(array, accept_sparse=None, dtype="numeric", order=None,
    ...
    """
    # print("check_array has been called")
    addfreq()
...
def check_X_y(X, y, accept_sparse=None, dtype="numeric", order=None,
    ...
    """
    # print("check_X_y has been called")
    addfreq()
...
def column_or_1d(y, warn=False):
    ...
    """
    # print("column_or_1d has been called")
    addfreq()
    shape = np.shape(y)
    if len(shape) == 1:
        return np.ravel(y)
...
def check_random_state(seed):
    ...
    """
    # print("check_random_state has been called")
    addfreq()
...
def check_symmetric(array, tol=1E-10, raise_warning=True,
    ...
    """
    # print("check_symmetric has been called")
    addfreq()
...
def check_is_fitted(estimator, attributes, msg=None, all_or_any=all):
    ...
    """
    # print("check_is_fitted has been called")
    addfreq()
    if msg is None:
...
def check_non_negative(X, whom):
    ...
    """
    # print("check_non_negative has been called")
    addfreq()
